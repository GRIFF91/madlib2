...
const Storycard = (props) => {
  return (  
      <Card body inverse style={{ backgroundColor: '#333', borderColor: '#333' }}>
        <CardTitle>City Madlib</CardTitle>
        <CardText>As you walk along the main street in (city name) you see a large 
        ...
        thanks you and asks you to a dinner of (food).</CardText>
